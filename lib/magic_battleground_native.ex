defmodule MagicBattlegroundNative do
  import MagicBattlegroundWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {MagicBattlegroundWeb.Layouts.SwiftUI, :app}
        ]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([MagicBattlegroundWeb, CoreComponents, plugin.module_suffix])
